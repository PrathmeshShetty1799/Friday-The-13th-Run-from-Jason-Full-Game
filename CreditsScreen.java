...
/**
 * The Credits Menu Screen will be the location for the citations of any foreign aspects of the game such as foreign code, images and softwares used
...
public class CreditsScreen implements Screen {
	...
	{		
		...
		//Pages
		backgroundPage1 = new Sprite( new Texture(Gdx.files.internal("F13-Assets/Buttons and Menus/CreditsBackground1.jpg")));
		backgroundPage1.setPosition(0,0);			
		backgroundPage2 = new Sprite( new Texture(Gdx.files.internal("F13-Assets/Buttons and Menus/CreditsBackground2.jpg")));
